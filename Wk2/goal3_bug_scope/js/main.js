...
var myctr = 0;
	...
	myCounter1(5);     // sending in a call
	console.log("after function myctr: ", myctr);  // when its like this, the var inside will change myctr but then this
													// console will use the global var above
													// if there is no var in function than this console will use the local var
...
/*
	...
	var fname = "James";   // this the info that is going into var1
	...
	var nameFN = function (var1){
		...
		return name;  // it is then returning the name info back to the variable fullName

	};

	var fullName = nameFN(fname);   // so this is the variable that is sending the fname info above into the function
	console.log ("return full name: = ", fullName);
	console.log("var fname: ", fname);
	console.log("first name: ", firstName); //out of scope, can only use in function
	...
	*/
	...
	var nameFN = function (var1){
		...
		return closureFN;  // it is then returning the name info back to the variable fullName
