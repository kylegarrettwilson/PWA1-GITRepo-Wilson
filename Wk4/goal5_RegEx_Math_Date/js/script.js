...
*/
	...
	console.log(document.getElementById("tagbox").innerHTML = Math.random()); // generating a random number between zero and one to the tagbox on the html

	var rand = (Math.random() * 10 + 1);
	// this is making a random between one and ten. put the max on left and min on right so 10 + 1
	console.log("Random: " , rand);
	var num = Math.floor(rand);
	// this is taking the random number above and rounding it down to the closest integer
...
*/
	...
	console.log(new Date());  // this is printing the date and time
