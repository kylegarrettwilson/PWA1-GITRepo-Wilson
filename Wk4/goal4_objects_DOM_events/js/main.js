...
//{KEY : Value} pairings,
	...
	person = {
		name: "Bond",
		age: 35,
		secretAgent: true    // these three are called keys
...
// setter
	...
	person["age"]=40;
	// this is calling the key above and then changing it to 40. If there is not an "age" above than it will
	// just add "age" to the person object

	person.name = "JamesBond";  // doing the same thing with dot notation



//nested objects

	// this is an object in an object
...
console.log('------Object within an object, Arrays, Function ----------');
	...
	var thatGuy = {
		...
		showMyAdress : function () {   // this is a function that when ran will show the address
			var addr = this.address.street + ", " + this.address.city;  // this is a method
			return addr;
		}
	};

	console.log(thatGuy.showMyAdress()); // this is telling to run function on thatGuy
...
*/
	...
	var students = {name: "Jame Bond", gender: "male", job: "Student"};

	for(var key in students){ // this is a for loop that is running through all the keys in the object
...
*/
	...
	var myNum = 1;
	myString = myString(myNum); // converting to a string
	console.log("myString:", typeof myString, myString);
	myBool = Boolean(myString); // converting the string above to a boolean, one is a true, two is false
